...
export default {
  ...
  methods: {
    postFilm() {
      this.$http
        .post(
          "https://nanuu-movie-default-rtdb.firebaseio.com/movie.json",
          this.dataInputFilm
        )
        .then(
          () => {
